...
export WANDB_NAME=HyperEyes_30k_LoraV1.6.1_spV3_235B
...
export MEGATRON_LM_PATH='/mnt/tidalfs-bdsz01/usr/xxx/Megatron-LM'
...
$(which megatron) sft \
    ...
    --min_lr 1e-5 \
    --save  /mnt/tidalfs-bdsz01/dataset/llm_ckpt/video_agent/HyperEyes/LoraV1.6.3_spV3_wo_tail/235B \
    --eval_interval 600 \
    --save_interval 600 \
    --max_length 32000 \
    --num_workers 8 \
    ...
    --model_author chenjiabin \
    --model_name HyperEyes_38k_LoraV1.6.3_spV3_wo_tail_235B \
